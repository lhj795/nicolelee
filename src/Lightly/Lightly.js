                ...
                <div className={classes.wrap}>
                    ...
                    <div>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12} lg={8}>
                                <video className={classes.imgFitContent} src={img['Solution01.mp4']} autoPlay muted loop controls id="video" />
                            </Grid>
                            <Grid item sx={{ display: { xs: 'none', lg: 'flex' } }} lg={2} />
                        </Grid>
                        <GridFormat>
                    ...
                    <div>
                        <Box sx={{ margin: '10vh 0' }}>
                            <Grid alignItems='center' container spacing={3}>
                                ...
                                <Grid item lg={5} xs={12}>
                                    <video className={classes.imgFitContent} src={img['App01.mp4']} autoPlay muted loop controls id="video" />
                                </Grid>
                                <Grid item xs={1} sx={{ display: { xs: 'block', lg: 'none' } }} />
                        ...
                        <Box sx={{ margin: '10vh 0' }}>
                            <Grid container spacing={3}>
                                <Grid item lg={2} sx={{ display: { xs: 'none', lg: 'block' } }} />
                                <Grid item xs={12} lg={8}>
                                    <video className={classes.imgFitContent} src={img['App02.mp4']} autoPlay muted loop controls id="video" />
                                </Grid>
                                <Grid item lg={2} sx={{ display: { xs: 'none', lg: 'block' } }} />
                                <Grid item lg={2} xs={1} />
                                <Grid item lg={4} xs={10}>
                        ...
                        <Box sx={{ margin: '10vh 0' }}>
                            <Grid alignItems='center' container spacing={3}>
                                ...
                                <Grid item lg={5} xs={12}>
                                    <video className={classes.imgFitContent} src={img['App04.mp4']} autoPlay muted loop controls id="video" />
                                </Grid>
                    ...
                    <div>
                        ...
                        <Box sx={{ margin: '10vh 0' }}>
                            <Grid container spacing={3}>
                                <Grid item lg={5} xs={12}>
                                    <video className={classes.imgFitContent} src={img['Testing01.mp4']} autoPlay muted loop controls id="video" />
                                </Grid>
                                <Grid item xs={1}/>
                                <Grid item xs={10} lg={4}>
                                    <Typography variant='body1'>
